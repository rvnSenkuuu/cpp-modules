...
ShrubberyCreationForm::ShrubberyCreationForm(void) : Form("ShrubberyForm", "Targetless", 145, 137)
{
	std::cout << "ShrubberyCreationForm default constructor called" << std::endl;
}

ShrubberyCreationForm::ShrubberyCreationForm(const std::string &target) : Form("ShrubberyForm", target, 145, 137)
{
